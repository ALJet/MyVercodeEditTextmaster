...
public class VerificationCodeEditText extends AppCompatEditText
    ...
    public VerificationCodeEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        initAttrs(attrs);
        setBackgroundColor(getColor(android.R.color
        .transparent));
        initPaint();
    ...
    private void initAttrs(AttributeSet attrs){
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs,
                R.styleable.VerCodeEditText);
        mFigures = typedArray.getInteger(R.styleable
        .VerCodeEditText_figures,4);
        mVerCodeMargin = (int) typedArray.getDimension(R.styleable
        .VerCodeEditText_verCodeMargin,0);
        mBottomSelectedColor = typedArray.getColor(R.styleable
        .VerCodeEditText_bottomLineSelectedColor,getCurrentTextColor());
        mBottomNormalColor = typedArray.getColor(R.styleable
        .VerCodeEditText_bottomLineNormalColor,
                getColor(android.R.color.holo_blue_bright));
        mBottomLineHeight = typedArray.getDimension(R.styleable
        .VerCodeEditText_bottomLineHeight,dp2px(5));
        mSelectedBackgroundColor = typedArray.getColor(R.styleable
        .VerCodeEditText_selectedBackgroundColor,
    ...
    private void initPaint(){
        ...
        mNormalBackgroundPaint.setColor(getColor(android.R
        .color.transparent));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //每个矩形形的宽度
        mEachRectLength = (widthResult - (mVerCodeMargin *
                (mFigures - 1))) / mFigures;
        //最终的高度
    ...
    public void onTextChanged(CharSequence charSequence, int i, int i1, int i2) {
        ...
        if(onCodeChangedListener != null){
            onCodeChangedListener.onVerCodeChanged(getText()
            ,i,i1,i2);
        }
    }
    ...
    public void afterTextChanged(Editable editable) {
        ...
        if(getText().length() == mFigures){
            ...
            getText().delete(mFigures,getText()
            .length());
        }
    }
    ...
    public void setSelectedBackgroundColor(int selectedBackgroundColor) {
        this.mSelectedBackgroundColor = getColor(selectedBackgroundColor);
        postInvalidate();
    }
    ...
    public void showKeyBoard(Context context){
        ...
        imm.showSoftInput(this,InputMethodManager
        .SHOW_FORCED);
    }
}
